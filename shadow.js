// WebGL2 - Shadows - Basic w/directional light
// from https://webgl2fundamentals.org/webgl/webgl-shadows-w-directional-light.html
...
function main() {
  ...
  const planeUniforms = {
    u_colorMult: [0.5, 0.5, 1, 0.5],  // lightblue
    u_color: [1, 0, 0, 1],
